...
(function() {
  var Encryptor, KEY, LOCAL_ADDRESS, METHOD, PORT, REMOTE_PORT, SCHEME, SERVER, WebSocket, config, configContent, configFromArgs, daemon, fs, getServer, http, inetNtoa, k, net, options, parseArgs, path, prepareServer, ref, runInDaemon, s, server, timeout, url, v;
  ...
  runInDaemon = function() {
    var errorLog, infoLog;
