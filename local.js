...
(function() {
  var Encryptor, KEY, LOCAL_ADDRESS, METHOD, PORT, REMOTE_PORT, SCHEME, SERVER, HTTPPROXY, WebSocket, config, configContent, configFromArgs, fs, getServer, http, inetNtoa, k, net, options, parseArgs, HttpsProxyAgent, path, prepareServer, ref, s, server, timeout, url, v;
      ...
      if (stage === 1) {
        try {
          ...
          if ( HTTPPROXY ){
              ...
              var endpoint = aServer;
              var parsed = url.parse(endpoint);
              //console.log('attempting to connect to WebSocket %j', endpoint);
               
              // create an instance of the `HttpsProxyAgent` class with the proxy server information 
              var opts = url.parse(HTTPPROXY);
